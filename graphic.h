...
public:
    ...
    enum Functions{circle, clover,Archimedes,snail}; // enum -команда, позволяющая перечислить список констант. Functions - список переменных,в курсе это были Shape(как-то так).
                                                    //Список внитри скобок, это название графиков, его можно изменять.
