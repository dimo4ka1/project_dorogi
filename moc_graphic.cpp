...
QT_MOC_LITERAL(1, 8, 22), // "signalTargetCoordinate"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 10) // "mousepoint"

    },
    "Graphic\0signalTargetCoordinate\0\0"
    "mousepoint"
};
...
void Graphic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Graphic::*)(QPointF );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Graphic::signalTargetCoordinate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Graphic::signalTargetCoordinate(QPointF _t1)
{
